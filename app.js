...
//(name, id, email, officeNumber)
    .prompt([
        ...
        {
            type: "input",
            message: "What is the ID of the Office Manager?",
            name: "id",
            default: "42b"
        },
        {
            type: "input",
            message: "What is the Email of the Office Manager?",
            name: "email",
            default: "defaultname@gmail.com"
        },
        {
            type: "input",
...
function promptNextEmployee(){
    ...
    .prompt([
        ...
        if(answers.another == "Yes"){
            ...
            fs.writeFile(outputPath, render(employeeArray), err => { console.log(err) });
        }
    });
}
